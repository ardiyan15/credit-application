...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/bi_checking', [ApprovalController::class, 'bi_checking'])->name('approval.bi_checking');
    Route::post('bi_checking_approval', [ApprovalController::class, 'bi_checking_approval'])->name('approval.bi_checking_approval');
