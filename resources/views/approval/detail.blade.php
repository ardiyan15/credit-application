                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <a href="{{ route('approval.index') }}"
                                            class="btn btn-secondary btn-sm mt-4">Kembali</a>
                                    </div>
                                    <div class="col-lg-6">
                                        <table>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td id="td_limit">@currency($customer->limit_kredit)</td>
                                            </tr>
                                            <tr>
                                                <th>Jangka Waktu</th>
                                                <td>:</td>
                                            ...
                                            <tr>
                                                <th>Cicilan</th>
                                                <td>:</td>
                                                <td id="result">@currency($customer->calculation->bunga_per_bulan)</td>
                                            </tr>
                                        </table>
